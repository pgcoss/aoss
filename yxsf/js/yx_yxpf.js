...
(function __init_pingfen(){
    ...
    for (var i = 0; i < 10; i++){
        ...
        //
        const _wr_text = '<img src=\"https://cdn.jsdelivr.net/gh/xmfans/pltoss/yxsf/pic/icon/rank_' + _gif_index + '.gif\">';
   ...
   for (var i = 0; i < 10; i++){
       ...
       //
       const _wr_text = '<img title=\"' + ((i+1)*0.5).toFixed(1) + '\" src=\"https://cdn.jsdelivr.net/gh/xmfans/pltoss/yxsf/pic/icon/rank_' + _gif_index + '.gif\">';
       _html_texts += _wr_text;
   }
